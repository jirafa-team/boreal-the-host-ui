            ...
            {activeTab === "inicio" && (
              <div className="space-y-6">
                <div className="px-4 pt-4">
                  <div className="relative overflow-hidden rounded-xl p-4 text-white" style={{ background: "linear-gradient(135deg, #0f172a 0%, #1e3a8a 50%, #581c87 100%)" }}>
                    {/* Radial gradient overlays for subtle metallic effects */}
                    <div className="absolute inset-0 opacity-30 pointer-events-none">
                      <div className="absolute top-0 right-0 w-64 h-64 bg-blue-300 rounded-full mix-blend-screen filter blur-3xl"></div>
                      <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-300 rounded-full mix-blend-screen filter blur-3xl"></div>
                    </div>
